...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public delegate void CellViewStartEndChangedDelegate(EnhancedScroller scroller);
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        public CellViewStartEndChangedDelegate scrollerStartEndChanged;
        ...
        public float NormalizedScrollPosition
        {
            get
            {
                ...
                return (scrollPosition <= 0 || ScrollSize == 0 ? 0 : _scrollPosition / ScrollSize);
            }
        }
        ...
        public int StartDataIndex
        {
            get
            {
                return NumberOfCells > 0 ?_activeCellViewsStartIndex % NumberOfCells : 0;
            }
        }
        ...
        public int EndDataIndex
        {
            get
            {
                return NumberOfCells > 0 ? _activeCellViewsEndIndex % NumberOfCells : 0;
            }
        }
            ...
            )
        {
            ...
            if (dataIndex < 0)
            {
                ...
                Debug.Log($"JumpToDataIndex : {dataIndex}");
            }
        ...
        {
//            Debug.Log($"GetCellViewIndexAtPosition _cellViewOffsetArray.Count : {_cellViewOffsetArray.Count}");
        ...
        public EnhancedScrollerCellView GetActiveCellVeiw(int index)
        {
            if (index < 0 || index >= _activeCellViews.Count)
            {
                return null;    
            }
            
            return _activeCellViews[index];
        }
        ...
        public void _Resize(bool keepPosition)
        {
            ...
            {
                Debug.Log($"_Resize _scrollPosition : {_scrollPosition}");    
            }
...
//                }
//                
////                Debug.Log($"_scrollPosition : {_scrollPosition}, endPosition : {endPosition}" );
//                        
//            }
        ...
        {
//            Debug.Log($"_GetCellIndexAtPosition position : {position}, startIndex : {startIndex}, endIndex : {endIndex}");
...
//            }
            ...
            _RefreshActive();
            scrollerStartEndChanged?.Invoke(this);
        }
