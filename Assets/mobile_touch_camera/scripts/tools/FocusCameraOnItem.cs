...
namespace BitBenderGames {
  ...
  public class FocusCameraOnItem : MonoBehaviourWrapped {
    ...
    public void FocusCameraOnTarget(Vector3 targetPosition, Quaternion targetRotation) {
      FocusCameraOnTarget(targetPosition, targetRotation, MobileTouchCamera.CamZoom);
    }
    ...
    public void SetTransform(Vector3 newPosition, Quaternion newRotation, float newZoom) {
