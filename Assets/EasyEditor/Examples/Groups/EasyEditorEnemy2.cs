...
namespace EasyEditor
{
    ...
    /// </summary>
    public class EasyEditorEnemy2 : MonoBehaviour
    {
        [Image]
        ...
        [Inspector(group = "Basic Settings", foldable = true)]
    	[Comment("this option is not optimized for mobiles.")]
        public bool usePhysic = true;
        public Vector3 initialPosition;
    	
        [Inspector(group = "Advanced Settings", foldable = true, groupDescription = "These settings can only be" +
