...
#if UNITY_ANDROID
using Trucking.Notifications.Android;
...
namespace Trucking.Notifications
{
    /// <summary>
    /// Global notifications manager that serves as a wrapper for multiple platforms' notification systems.
    /// </summary>
    public class GameNotificationsManager : MonoSingleton<GameNotificationsManager>
    {
        ...
        {
            mode = OperatingMode.ClearOnForegrounding;
