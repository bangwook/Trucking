    ...
    public class MB_Utility
    {
        ...
        public static Material[] GetGOMaterials(GameObject go)
        {
            ...
            else
            {
                ...
                {
                    Debug.LogWarning("Object " + go + " has only " + mesh.subMeshCount + " submeshes and has " +
                                     sharedMaterials.Length + " materials. Extra materials do nothing.");
...
//            if (p != null && p.Equals("")) // don't try to destroy assets
                ...
                if (PrefabUtility.IsPartOfPrefabInstance(o))
                {
                    ...
                    var prefabInstance = PrefabUtility.GetPrefabInstanceHandle(o);
                    //destroy the handle
