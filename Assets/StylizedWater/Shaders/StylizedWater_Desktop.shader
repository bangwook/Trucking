...
Shader "StylizedWater/Desktop"
{
	Properties
	{
		...
		[Toggle]_RT_REFRACTION("RT_REFRACTION", Float) = 0
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			o.vertexToFrag899 = ( ( ( 1.0 - appendResult756 ) / _SWS_RENDERTEX_POS.x ) + ( ( _SWS_RENDERTEX_POS.x / ( _SWS_RENDERTEX_POS.x * _SWS_RENDERTEX_POS.x ) ) * (ase_worldPos).xz ) );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float distanceDepth641 = ( screenDepth641 - LinearEyeDepth( ase_screenPosNorm.z ) ) / (  lerp( 1.0 , ( 1.0 / _ProjectionParams.z ) , unity_OrthoParams.w) );
			//End - Stylized Water custom depth
			float DepthTexture494 = distanceDepth641;
			float2 RT_UV763 = i.vertexToFrag899;
			...
			float OpacityFinal814 = saturate( ( ( DepthTexture494 / _EdgeFade ) - ( RT_Opacity750 + (VertexColors810).r ) ) );
			...
			float Opacity121 = saturate( ( ( ( _Transparency + Intersection42 ) - ( ( 1.0 - Depth479 ) * ( 1.0 - lerpResult943 ) ) ) - i.vertexColor.g ) );
			...
			float4 temp_cast_7 = (( Heightmap99 * _Wavetint )).xxxx;
			float4 RimColor102 = _RimColor;
			float4 lerpResult61 = lerp( saturate( ( WaterColor350 - temp_cast_7 ) ) , ( RimColor102 * 3.0 ) , Intersection42);
			...
			float4 lerpResult223 = lerp( lerpResult207 , temp_cast_8 , WaveFoam221);
			float4 temp_cast_9 = (1.0).xxxx;
			float4 Shadows834 = lerp(temp_cast_9,saturate( ( unity_AmbientSky / ( 1.0 - tex2DNode833.r ) ) ),_ENABLE_SHADOWS);
			float4 FinalColor114 = ( lerpResult223 * Shadows834 );
			#ifdef _LIGHTING_ON
				float4 staticSwitch952 = float4( 0,0,0,0 );
			#else
				float4 staticSwitch952 = saturate( ( ( ShadowMask944 * pow( max( 0.0 , dotResult866 ) , ( GlossinessParam877 * 128.0 ) ) ) + lerp(( float4( ase_lightColor.rgb , 0.0 ) * FinalColor114 ),FinalColor114,_Unlit) ) );
			#endif
...
/*ASEBEGIN
Version=16100
1928;29;1905;1004;2537.457;4145.312;1.3;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;382;-2973.885,-2047.095;Float;False;3000.035;1049.284;Comment;29;923;834;844;833;925;265;126;260;806;801;805;372;804;359;920;361;922;919;266;360;269;494;641;933;936;938;944;954;955;Reflection/Refraction/Depth;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SWS_Depth;641;-1751.344,-1115.689;Float;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;721;-1719.215,3187.987;Float;False;Property;_SECONDARY_WAVES;SECONDARY_WAVES;39;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;776;-1256.763,4604.605;Float;False;IntersectionSource;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;10;-1157.329,-21.75855;Float;False;Property;_RimColor;Rim Color;4;0;Create;True;0;0;False;0;1,1,1,0.5019608;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;477;-3101.106,-2794.325;Float;False;Property;_WaterShallowColor;WaterShallowColor;1;0;Create;True;0;0;False;0;0.4191176,0.7596349,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;781;-1417.933,-3328.931;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;782;-1084.952,-3407.833;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;372;-1644.772,-2003.788;Float;False;Global;_GrabScreen0;Grab Screen 0;34;0;Create;True;0;0;False;0;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-2334.419,-2352.103;Float;False;Property;_ReflectionFresnel;Reflection Fresnel;10;0;Create;True;0;0;False;0;5;0;2;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;60;-3099.254,-2605.115;Float;False;Property;_WaterColor;Water Color;0;0;Create;True;0;0;False;0;0.1176471,0.6348885,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;126;-1006.137,-1932.838;Float;False;RefractionResult;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;946;-3055.149,2470.876;Float;False;Property;_MACRO_WAVES;MACRO_WAVES;38;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;202;-2418.637,-825.0979;Float;False;Property;_FresnelColor;Fresnel Color;3;0;Create;True;0;0;False;0;1,1,1,0.484;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;947;-1312.879,2137.847;Float;False;Property;_MACRO_WAVES;MACRO_WAVES;39;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;948;-1105.128,2337.141;Float;False;Property;_MACRO_WAVES;MACRO_WAVES;39;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;722;-1571.591,5112.883;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;861;-2503.368,5748.755;Float;False;3267.734;909.3911;Comment;18;875;887;874;873;879;880;872;870;867;869;868;865;866;863;864;862;952;958;Lighting;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;862;-2435.75,5905.482;Float;False;52;NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldReflectionVector;863;-2193.821,5906.891;Float;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;865;-1678.094,6087.037;Float;False;877;GlossinessParam;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;868;-1425.728,6088.199;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;128;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;816;-2210.829,-4204.977;Float;False;1497.175;524.8193;Comment;10;811;809;2;767;489;786;498;770;814;953;Opacity;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;880;-1093.456,5970.647;Float;False;944;ShadowMask;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;879;-922.6326,6130.012;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;874;-757.9039,6208.751;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SwizzleNode;809;-1879.283,-3807.724;Float;False;FLOAT;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1574.322,2975.444;Float;False;Property;_WaveHeight;Wave Height;27;0;Create;True;0;0;False;0;0.05;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;786;-1687.255,-3930.708;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;498;-1683.42,-4134.152;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;887;-562.8474,6200.75;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;952;-294.4478,6152.723;Float;False;Property;_LIGHTING;LIGHTING;43;0;Create;True;0;0;False;0;0;1;0;True;;Toggle;2;Key0;Key1;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;770;-1399.21,-4097.162;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;953;-1221.076,-4108.181;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;814;-956.6533,-4154.977;Float;False;OpacityFinal;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;855;2265.909,-411.5951;Float;False;834;Shadows;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;815;2076.935,5.32964;Float;False;814;OpacityFinal;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;923;-2317.433,-1229.282;Float;False;            float4 color = 0@$            float2 blurSize = 0.1@$            float2 ouv = uv.xy@$            float k = 1.0 / 9@$            for(int y=0@ y<3@ y++) {$                for(int x=0@ x<3@ x++) {$                    float2 offset = float2(x-1, y-1)@$					uv.xy = ouv + blurSize * offset@$                    float4 c = tex2D(s, uv)@ $                    color += c * k@$                }$            }$            return color@;1;False;2;True;s;SAMPLER2D;0.0;In;;Float;True;uv;FLOAT2;0,0;In;;Float;Blur;True;False;0;2;0;SAMPLER2D;0.0;False;1;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;657;1680.501,383.0405;Float;False;Constant;_Float15;Float 15;37;0;Create;True;0;0;False;0;50;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;233;-2187.434,629.9498;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceBasedTessNode;655;1930.161,288.6733;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;780;-2453.334,86.1601;Float;False;494;DepthTexture;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;101;2098.581,120.8756;Float;False;100;Displacement;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;234;1563.903,275.5;Float;False;Property;_Tessellation;Tessellation;28;0;Create;True;0;0;False;0;0.1;0;0.1;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;846;1387.167,-67.87299;Float;False;944;ShadowMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;857;2256.308,-338.7852;Float;False;Property;_LIGHTING;LIGHTING;48;0;Create;True;0;0;False;0;0;1;0;True;;Toggle;2;Key0;Key1;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;656;1676.08,466.8108;Float;False;Constant;_Float14;Float 14;37;0;Create;True;0;0;False;0;250;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;470;-3783.626,599.2585;Float;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2625.578,-276.458;Float;False;True;3;Float;;200;0;CustomLighting;StylizedWater/Desktop;False;False;False;False;False;False;False;False;True;False;False;False;False;False;True;True;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;1;4;10;25;True;0.5;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;1;False;-1;4;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;200;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;770;0;498;0
WireConnection;770;1;786;0
WireConnection;875;0;952;0
WireConnection;953;0;770;0
...
ASEEND*/
//CHKSM=57AC401481DA96DDC0AFB4A84E16C6FFF18E68E3